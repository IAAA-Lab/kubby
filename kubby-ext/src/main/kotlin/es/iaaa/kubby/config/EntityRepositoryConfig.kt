...
/**
 * Maps the [List] of configuration nodes to a list of [RewrittenEntityRepository].
 */
internal fun List<ApplicationConfig>.toMapToDataSources(): List<RewrittenEntityRepository> =
    map {
