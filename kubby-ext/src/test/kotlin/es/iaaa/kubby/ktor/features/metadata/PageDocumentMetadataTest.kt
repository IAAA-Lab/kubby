...
import es.iaaa.kubby.rest.api.PageContentContext
...
class PageDocumentMetadataTest {
    private lateinit var model: Model
    private lateinit var context: PageContentContext
    ...
    fun before() {
        ...
        every { context.entity.uri } returns "http://localhost/resource/ResourceOfSomething"
